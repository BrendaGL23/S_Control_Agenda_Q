...
<br>
    ...
    <label for="nompa"><b>Nombre del paciente</b></label><span class="badge-warning">*</span>
    <input type="text" name="nompa" value="<?php echo $_SESSION['username']; ?>" readonly>

    <!-- Agregar un campo oculto para almacenar el id del paciente -->
    <input type="hidden" name="apppac" value="<?php echo $_SESSION['id']; ?>">
    ...
    <label for="psw"><b>Sede</b></label><span class="badge-warning">*</span>
    <select required name="appidsede" id="sede">
        <option>Seleccione</option>
    </select>
    ...
    <script src="../../backend/js/sede.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
     <?php include_once 'add_appointment.php' ?>
