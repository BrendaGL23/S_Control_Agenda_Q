...
<head>
    ...
    <title>Actualizar enfermera(o)</title>
</head>
<body>
    <main class="page">
    <!-- SIDEBAR -->
    ...
    <ul class="breadcrumbs">
        ...
        <li class="divider">></li>
        <li><a href="#" class="active">Actualizar sede</a></li>
    </ul>
    ...
    <div class="containerss">
        ...
        <hr>
        <input type="hidden" name="sedeid" value="<?php echo $sede->idsede; ?>">

        <label for="num_emp"><b>Número de Empleado</b></label><span class="badge-warning">*</span>
        <input type="text" placeholder="Ejemplo: 12345" value="<?php echo $sede->num_emp; ?>" name="num_emp" maxlength="20" required>

        <label for="nombre"><b>Nombre de la Sede</b></label><span class="badge-warning">*</span>
        <input type="text" placeholder="Ejemplo: Hospital XYZ" value="<?php echo $sede->nombre; ?>" name="nombre" required>

        <label for="direccion"><b>Dirección</b></label><span class="badge-warning">*</span>
        <input type="text" placeholder="Ejemplo: Calle Principal 123" value="<?php echo $sede->direccion; ?>" name="direccion" required>

        <label for="ciudad"><b>Ciudad</b></label><span class="badge-warning">*</span>
        <input type="text" placeholder="Ejemplo: Ciudad ABC" value="<?php echo $sede->ciudad; ?>" name="ciudad" required>

        <label for="estado"><b>Estado</b></label><span class="badge-warning">*</span>
        <input type="text" placeholder="Ejemplo: Activo" value="<?php echo $sede->estado; ?>" name="estado" required>

        <label for="codigo_postal"><b>Código Postal</b></label><span class="badge-warning">*</span>
        <input type="text" placeholder="Ejemplo: 12345" value="<?php echo $sede->codigo_postal; ?>" name="codigo_postal" maxlength="20" required>

        <label for="telefono"><b>Teléfono</b></label><span class="badge-warning">*</span>
        <input type="text" placeholder="Ejemplo: (123) 456-7890" value="<?php echo $sede->telefono; ?>" name="telefono" maxlength="20" required>

        <label for="correo"><b>Correo Electrónico</b></label><span class="badge-warning">*</span>
        <input type="email" placeholder="Ejemplo: correo@ejemplo.com" value="<?php echo $sede->correo; ?>" name="correo" required>

        <label for="estado_sede"><b>Estado de la Sede</b></label><span class="badge-warning">*</span>
        <input type="text" placeholder="Ejemplo: A" value="<?php echo $sede->estado_sede; ?>" name="estado_sede" maxlength="1" required>

        <hr>
        <button type="submit" name="upd_sede" class="registerbtn">Guardar</button>
    </div>
</form>
   ...
   <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    <?php include_once '../../backend/php/upd_sede.php' ?>
